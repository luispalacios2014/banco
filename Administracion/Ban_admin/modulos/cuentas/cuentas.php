...
class cuentas_cuentas {
    ...
    */
    ...
    /*
    * @funcion PONER UNA CUNETA PRINCIPAL
    */
   ...
   /*
    * @funcion MODIFICAR CUENTAS Y PERSONAS JURIDICAS
    */
    function modificar() {
    $id_cuenta = $_GET['id_cuenta'];
    $a = new Conexion();
    ...
    /*
    * @funcion ACTUALIZAR PERSONAS NATURALES Y CUENTAS
    */
    function actualizar() {
        $a = new Conexion();
        $modulo = "cuentas";
        ...
        $sql2 = ("update persona_natural set direccion='$direccion', telefono='$telefono' where cliente_id=$id_cliente");
        $a->execute($sql1);
        $a->execute($sql2);
        $a->mensaje_actualizar($modulo, $archivo, $accion);
        ...
        $sql6 = ("update persona_natural set direccion='$direccion', telefono='$telefono' where cliente_id=$id_cliente");
        $a->execute($sql5);
        $a->execute($sql6);
        $a->mensaje_actualizar($modulo, $archivo, $accion);
        ...
        $sql01 = ("update cuenta set Actived=$estadoInactivo8 where id=$id_cuenta");
        $a->execute($sql01);
        $a->mensaje_actualizar($modulo, $archivo, $accion);
        }
        }
