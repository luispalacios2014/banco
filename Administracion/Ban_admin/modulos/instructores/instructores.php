...
/**
 * Class instructores
 * @package Gym\Administracion\Gym_admin\modulos\instructores\instructores
 */
class instructores_instructores

{
    /**
     * MODULO REGISTRAR INSTRUCTORES
     */
    function registrar()
    {
        ?>
    ...
    /*
     *@funcion MODULOS LISTAR INSTRUCTORES
     */
    function listar(){
        ?>
    ...
    /*
    *@funcion MODULO MODIFICAR INSTRUCTORES
    */
    function modificar()
    {
        $ins_id=$_GET['Ins_Id'];
    ...
    /*
     *@funcionACTUALIZAR INSTRUCTORES
     */
    function actualizar()
    {
        /** @var TYPE_NAME $identificacion */
